...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    // !!! viewResolver objectimi bean olarak ekliyorum !! Neden bean? Cunku hem class hazir hem de method
    @Bean
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) { // butun ayarlarimi registry uzerinden yapicam
